...
public class AssemblingMachineScreen extends AbstractContainerScreen<AssemblingMachineMenu> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(EvoTech.MOD_ID, "textures/gui/assembling_machine_gui.png");

    public AssemblingMachineScreen(AssemblingMachineMenu menu, Inventory inv, Component title) { super(menu, inv, title); }
